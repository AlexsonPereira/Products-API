...
describe('Testes rota /products', () => {
  ...
  it('Testando listagem de produtos por id da categoria', async () => {
    const response = await request(app).get(`/products/category/${testCategory.id}`)
  ...
  it('Testando delecao de uma categoria', async () => {
    const response = await request(app).delete(`/categories/${testCategory.id}`)
...
describe('Testando casos de erro nas rotas /categories e /products', () => {
  ...
  it('Nao permite criacao de duas categorias com nomes iguais', async () => {
    const successResponse = await request(app).post('/categories').send(testCategory)

    const errorResponse = await request(app).post('/categories').send(testCategory)
  ...
  it('Nao permite atualizar uma categoria inexistente', async () => {
    const response = await request(app).patch('/categories/id_test').send({ name: 'Teste' })
  ...
  it('Nao permite atualizar um produto inexistente', async () => {
    const response = await request(app).patch('/products/id_test').send({ name: 'Teste' })
